...
function ExplorarContent() {
  ...
  return (
    <div className="pt-20 pb-16">
      {/* Page header */}
      <div className="section-padding mb-8" data-animate>
        <span className="text-primary-600 text-xs font-semibold tracking-[0.15em] uppercase mb-3 block">
          Descubre el Per&uacute;
        </span>
        <h1 className="text-3xl md:text-4xl font-display font-bold text-warm-900 mb-2">
          Explora restaurantes
        </h1>
        <p className="text-warm-500 leading-relaxed">
          Filtra por ubicaci&oacute;n, categor&iacute;a y encuentra tu pr&oacute;xima experiencia gastron&oacute;mica.
        </p>
        ...
        <div className="flex gap-3 mt-6">
          ...
          <button
            ...
            className="lg:hidden flex items-center gap-2 px-4 py-2.5 border border-warm-200 rounded-full text-sm text-warm-700 hover:bg-warm-100 transition-all duration-200"
          >
            ...
            <div className="fixed inset-0 z-50 lg:hidden">
              ...
              <div className="absolute right-0 top-0 bottom-0 w-80 max-w-full bg-white p-6 overflow-y-auto shadow-2xl">
                <div className="flex items-center justify-between mb-6">
                  <h2 className="text-lg font-display font-semibold text-warm-900">Filtros</h2>
                  <button
                    onClick={() => setMobileFiltersOpen(false)}
            ...
            {resultados.length > 0 ? (
              ...
              <div className="text-center py-20" data-animate>
                ...
                <p className="text-warm-500">
                  Intenta ajustar los filtros o buscar con otros t&eacute;rminos.
                </p>
              </div>
            )}
          </div>
      ...
      fallback={
        <div className="pt-20 pb-16 section-padding">
          <div className="animate-pulse space-y-4">
            ...
            <div className="h-6 bg-warm-200 rounded w-2/3" />
          </div>
        </div>
      }
    >
