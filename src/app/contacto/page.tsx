...
export const metadata: Metadata = {
  title: 'Contacto',
  description: 'Ponte en contacto con el equipo de Ruta del Sabor. Instagram, correo electrónico y X.',
  openGraph: {
...
const contactLinks = [
  {
    ...
    description: 'Síguenos en Instagram para ver novedades, fotos y contenido gastronómico.',
  ...
  },
  {
    ...
    description: 'Escríbenos para consultas, colaboraciones o sugerencias de restaurantes.',
    cta: 'Enviar correo',
    icon: (
      <svg className="w-7 h-7" viewBox="0 0 24 24" fill="currentColor">
  ...
  },
  {
    ...
    description: 'Síguenos en X para actualizaciones rápidas, noticias gastronómicas y más.',
    cta: 'Abrir en X',
    icon: (
      <svg className="w-7 h-7" viewBox="0 0 24 24" fill="currentColor">
...
export default function ContactoPage() {
  return (
    <div className="pt-24 pb-20">
      {/* Header */}
      <div className="section-padding max-w-3xl mx-auto text-center mb-14">
        <span className="inline-block bg-primary-50 text-primary-700 text-sm font-medium px-4 py-1.5 rounded-full mb-4 tracking-wide uppercase">
          Contacto
        </span>
        ...
        <p className="text-lg text-gray-500 max-w-xl mx-auto">
          ¿Tienes un restaurante para recomendar, quieres colaborar o simplemente
          quieres charlar de comida peruana? Escríbeme por cualquiera de estos medios.
        </p>
      </div>
      ...
      <div className="section-padding max-w-3xl mx-auto grid grid-cols-1 gap-5">
        {contactLinks.map((c) => (
          <a
            ...
            className={`group flex items-center gap-6 p-6 rounded-2xl border ${c.bgColor} ${c.borderColor} hover:shadow-lg transition-all duration-300 hover:-translate-y-0.5`}
          >
            {/* Icon */}
            ...
            {/* CTA arrow */}
            <div className={`flex-shrink-0 flex items-center gap-2 text-sm font-medium ${c.textColor} group-hover:translate-x-1 transition-transform`}>
      ...
      {/* Footer note */}
      <div className="section-padding max-w-3xl mx-auto mt-12 text-center">
        <p className="text-sm text-gray-400">
          ¿Eres dueño de un restaurante y quieres aparecer en Ruta del Sabor?{' '}
          <a
